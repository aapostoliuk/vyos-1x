...
def get_config(config=None):
    ...
    # #Should be rewritten with migration after adding to accel-ppp general pattern
    # if dict_search('authentication.radius.timeout', pptp):
    #     if not dict_search('authentication.radius.timeout', config_without_defaults):
    #         pptp["authentication"]["radius"]["timeout"] = '30'
    #
    # #Should be rewritten with migration after adding to accel-ppp general pattern
    # if dict_search('authentication.radius.acct_timeout', pptp):
    #     if not dict_search('authentication.radius.acct_timeout', config_without_defaults):
    #         pptp["authentication"]["radius"]["acct_timeout"] = '30'
